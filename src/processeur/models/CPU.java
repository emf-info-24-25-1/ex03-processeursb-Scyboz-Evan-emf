...
public class CPU {
    ...
    public String format(long x) {
        ...
        return format.format(x); // Merci stackoverflow :/
    }

    public String toString() {
        return ("En " + annee + " le CPU " + nom + " avec " + format(transistors) +
        " transistors et une puissance de calcul " + (getMips() == UNKNOWN_MIPS ? "inconnue": "de "+mips+" mips."));
    }
}